...
namespace Blacklight.Controls.Wpf
{
    ...
    // KCW
    public delegate void ExpanderState(bool? minimized, bool? maximized);
    // End KCW
    ...
    {
        // KCW
        public ExpanderState StateNotification;
        // End KCW
        ...
        public bool IsExpanded
        {
            ...
            set
            {
                if (this.StateNotification != null)
                {
                    this.StateNotification(null, value);
                }
