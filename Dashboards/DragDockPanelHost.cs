...
namespace Blacklight.Controls.Wpf
{
    ...
    {
        private static uint sequenceNext = 1;
        public uint sequence { get; private set; }
        public UInt16 BookChapter { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<DragDockPanel> panels { get; private set; } = new List<DragDockPanel>();
        ...
        public DragDockPanelHost()
        {
            ...
            this.sequence = DragDockPanelHost.sequenceNext++;
        }
        #endregion
